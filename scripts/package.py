...
metadata = dict(category='General', changelog='Reconcile film and series person links by shared external IDs, preferring existing Russian person cards. Preserve roles and respect library scope and metadata locks.',
