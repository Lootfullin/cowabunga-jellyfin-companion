...
metadata = dict(category='General', changelog='Persist background artwork image references in the Jellyfin database after saving files. Repair existing references on subsequent cloud artwork checks.',
